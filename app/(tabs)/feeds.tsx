...
const BUILTIN_FEEDS: CustomFeed[] = [
  ...
  { id: 'notebookcheck', name: 'Notebookcheck', url: 'https://www.notebookcheck.net/', rss_url: 'https://www.notebookcheck.net/RSS-Feed-Notebook-Reviews.8156.0.html', icon: 'https://www.google.com/s2/favicons?domain=www.notebookcheck.net&sz=64', added_at: 0 },
  { id: '9to5linux', name: '9to5Linux', url: 'https://9to5linux.com/', rss_url: 'https://9to5linux.com/feed', icon: 'https://www.google.com/s2/favicons?domain=9to5linux.com&sz=64', added_at: 0 },
  { id: 'infoworld', name: 'InfoWorld', url: 'https://www.infoworld.com/', rss_url: 'https://www.infoworld.com/feed/', icon: 'https://www.google.com/s2/favicons?domain=www.infoworld.com&sz=64', added_at: 0 },
  { id: 'openai', name: 'OpenAI', url: 'https://openai.com/news/', rss_url: 'https://openai.com/news/rss.xml', icon: 'https://www.google.com/s2/favicons?domain=openai.com&sz=64', added_at: 0 },
